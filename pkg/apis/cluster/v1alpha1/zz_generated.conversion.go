...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_ContainerRuntimeInfo_To_cluster_ContainerRuntimeInfo,
		Convert_cluster_ContainerRuntimeInfo_To_v1alpha1_ContainerRuntimeInfo,
		Convert_v1alpha1_EtcdSpec_To_cluster_EtcdSpec,
		Convert_cluster_EtcdSpec_To_v1alpha1_EtcdSpec,
...
func autoConvert_v1alpha1_ContainerRuntimeInfo_To_cluster_ContainerRuntimeInfo(in *ContainerRuntimeInfo, out *cluster.ContainerRuntimeInfo, s conversion.Scope) error {
	out.Name = in.Name
...
func Convert_v1alpha1_ContainerRuntimeInfo_To_cluster_ContainerRuntimeInfo(in *ContainerRuntimeInfo, out *cluster.ContainerRuntimeInfo, s conversion.Scope) error {
	return autoConvert_v1alpha1_ContainerRuntimeInfo_To_cluster_ContainerRuntimeInfo(in, out, s)
}

func autoConvert_cluster_ContainerRuntimeInfo_To_v1alpha1_ContainerRuntimeInfo(in *cluster.ContainerRuntimeInfo, out *ContainerRuntimeInfo, s conversion.Scope) error {
	out.Name = in.Name
	out.Version = in.Version
	return nil
}
...
func Convert_cluster_ContainerRuntimeInfo_To_v1alpha1_ContainerRuntimeInfo(in *cluster.ContainerRuntimeInfo, out *ContainerRuntimeInfo, s conversion.Scope) error {
	return autoConvert_cluster_ContainerRuntimeInfo_To_v1alpha1_ContainerRuntimeInfo(in, out, s)
}

func autoConvert_v1alpha1_EtcdSpec_To_cluster_EtcdSpec(in *EtcdSpec, out *cluster.EtcdSpec, s conversion.Scope) error {
	...
	out.Version = in.Version
	out.LeaderEndpoint = in.LeaderEndpoint
	return nil
}

// Convert_v1alpha1_EtcdSpec_To_cluster_EtcdSpec is an autogenerated conversion function.
func Convert_v1alpha1_EtcdSpec_To_cluster_EtcdSpec(in *EtcdSpec, out *cluster.EtcdSpec, s conversion.Scope) error {
	return autoConvert_v1alpha1_EtcdSpec_To_cluster_EtcdSpec(in, out, s)
}

func autoConvert_cluster_EtcdSpec_To_v1alpha1_EtcdSpec(in *cluster.EtcdSpec, out *EtcdSpec, s conversion.Scope) error {
	out.ClusterName = in.ClusterName
	out.ImageSource = in.ImageSource
	out.Address = in.Address
	out.Discovery = in.Discovery
...
// Convert_cluster_EtcdSpec_To_v1alpha1_EtcdSpec is an autogenerated conversion function.
func Convert_cluster_EtcdSpec_To_v1alpha1_EtcdSpec(in *cluster.EtcdSpec, out *EtcdSpec, s conversion.Scope) error {
	return autoConvert_cluster_EtcdSpec_To_v1alpha1_EtcdSpec(in, out, s)
}
...
func autoConvert_v1alpha1_MachineSpec_To_cluster_MachineSpec(in *MachineSpec, out *cluster.MachineSpec, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_EtcdSpec_To_cluster_EtcdSpec(&in.Etcd, &out.Etcd, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_cluster_MachineSpec_To_v1alpha1_MachineSpec(in *cluster.MachineSpec, out *MachineSpec, s conversion.Scope) error {
	...
	out.ConfigSource = (*v1.NodeConfigSource)(unsafe.Pointer(in.ConfigSource))
	if err := Convert_cluster_EtcdSpec_To_v1alpha1_EtcdSpec(&in.Etcd, &out.Etcd, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_MachineVersionInfo_To_cluster_MachineVersionInfo(in *MachineVersionInfo, out *cluster.MachineVersionInfo, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_ContainerRuntimeInfo_To_cluster_ContainerRuntimeInfo(&in.ContainerRuntime, &out.ContainerRuntime, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_cluster_MachineVersionInfo_To_v1alpha1_MachineVersionInfo(in *cluster.MachineVersionInfo, out *MachineVersionInfo, s conversion.Scope) error {
	out.Kubelet = in.Kubelet
	out.ControlPlane = in.ControlPlane
	if err := Convert_cluster_ContainerRuntimeInfo_To_v1alpha1_ContainerRuntimeInfo(&in.ContainerRuntime, &out.ContainerRuntime, s); err != nil {
		return err
	}
	return nil
}
